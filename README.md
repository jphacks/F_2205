...
既存のビデオ通話機能に加え、一つのビデオ通話にいながら、並行して別々の話題で会話することができます。
...
上記で上げた、課題である「**並行して会話することができないこと**」に対して

このサービスを通して以下のように解決できます。
...
私たちの作った**のみぱら🍺**は既存の課題であった「**並行して会話することができないこと**」を解決できました。
