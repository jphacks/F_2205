...
1. 部屋を作成する
   ...
   [こちら](https://jphacks-app.herokuapp.com/room/prepare) から room 作成ページにアクセスし、好きな部屋番号を入力します (例:1111)
...
この場合、A さんと B さんはお互いにフォーカスしあっており、
また、C さんと D さんもお互いにフォーカスしあっています。

このとき彼らはお互いの声以外は小さく聞こえており、
自分たちの好きな話題に集中して会話できます。

E さんはだれともフォーカスしあってないので、
...
この [miro.md](./doc/miro.md) に miro に書いた設計などをまとめてあります。
