...
しかし、オンライン飲み会では、発言者が特定の人物に限定されたり、
自分の好きなテーマについて発言するのに躊躇してしまいます。

対面時のように複数人が平行して会話することが難しいのです。

そこで私たちは、参加者全員が１つのビデオ通話にいながら、
自由に、そして自然な流れで会話グループを作ったり解散したりできるサービス「のみぱら」を
提案します。

「のみぱら」は、飲み会が大好きな皆さんに
これまでにないイノベーティブな飲み会プラットフォームを提供します。
